...
class AlarmReceiver: BroadcastReceiver() {
    companion object {
        ...
        const val ALARM_ONE_TIME = "onet_time_alarm"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val title = if (type.equals(ALARM_ONE_TIME, ignoreCase = true)) ALARM_ONE_TIME else ALARM_REPEATING
        val notifId = if (type.equals(ALARM_ONE_TIME, ignoreCase = true)) ID_ONE_TIME else ID_REPEATING
    ...
    fun cancelAlarm(context: Context, type: String) {
        val alarmManager = context.getSystemService(Context.ALARM_SERVICE) as AlarmManager
        val intent = Intent(context, AlarmReceiver::class.java)
        val requestCode = if (type.equals(ALARM_ONE_TIME, ignoreCase = true)) ID_ONE_TIME else ID_REPEATING
    ...
    private fun showAlarmNotification(context: Context, title: String, notifId: Int) {
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            ...
            .setContentText("Gihub App Waiting You :)")
